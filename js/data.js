...
let routsDetails = 		[
  							{
  								start: 'An der Schleuse - Königs Wusterhausen',
  								end: 'An der Schleuse - Königs Wusterhausen',
  								distance: 18
  							},
  							{
  								start: 'Restauracja „Schifferstube“ nad Dahme',
  								end: 'Restauracja „Schifferstube“ nad Dahme',
  								distance: 8
  							},
  							{
  								start: 'Wentowsee między Dannenwalde i Wentow',
  								end: 'Wypożyczalnia kajaków w Zehdenick',
  								distance: 11
  							},
  							{
  								start: 'Wypożyczalnia kajaków w Zehdenick',
  								end: 'Wentowsee między Dannenwalde i Wentow',
  								distance: 11
  							}
  						]
//-------------------------------------//
